...
HD_PWD='C:/Users/wang.haoqi/Desktop/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pdatapath_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pdatapath_top.tcl
